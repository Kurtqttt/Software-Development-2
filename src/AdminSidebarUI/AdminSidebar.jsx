...
import AdminPanelSettingsIcon from '@mui/icons-material/AdminPanelSettings'; // Changed icon
  ...
  return (
    <div className={`sidebar ${expanded ? 'w-60' : 'w-20'} h-screen fixed bg-CDF0EA text-019673 flex flex-col font-roboto rounded-20 transition-width ease-in-out duration-500 shadow-md overflow-hidden`}>
      ...
      <div className="sidebar__content flex-grow p-5 relative"> {/* Added 'relative' class */}
        {expanded && (
          <>
            <button className="sidebar__button flex items-center justify-center bg-transparent border-none text-019673 py-2 px-3 cursor-pointer text-lg hover:bg-gray-300 hover:text-white ml-2" style={{ width: '170px', paddingRight: '38px' }}>
              <AdminPanelSettingsIcon className="mr-2" /> {/* Changed icon */}
              Manage Users
            </button>
            <button className="sidebar__button flex items-center justify-center bg-transparent border-none text-019673 py-2 px-3 cursor-pointer text-lg hover:bg-gray-300 hover:text-white ml-2" style={{ width: '170px', paddingRight: '26px' }}>
